...
package com.ansh.rmbarcodetest.parser.specs;
...
import static com.ansh.rmbarcodetest.parser.specs.DataType.ANY;
import static com.ansh.rmbarcodetest.parser.specs.DataType.CARET_OR_GREATER_THAN;
import static com.ansh.rmbarcodetest.parser.specs.DataType.GREATER_THAN;
import static com.ansh.rmbarcodetest.parser.specs.DataType.N;
import static com.ansh.rmbarcodetest.parser.specs.DataType.NNNN_a;
import static com.ansh.rmbarcodetest.parser.specs.DataType.NNNN_f;
import static com.ansh.rmbarcodetest.parser.specs.DataType.NNNa;
import static com.ansh.rmbarcodetest.parser.specs.DataType.a;
import static com.ansh.rmbarcodetest.parser.specs.DataType.f;
import static com.ansh.rmbarcodetest.parser.specs.Element.Type.COND;
import static com.ansh.rmbarcodetest.parser.specs.Element.Type.MAN;
import static com.ansh.rmbarcodetest.parser.specs.Element.Type.NONE;
import static com.ansh.rmbarcodetest.parser.specs.Element.Type.SEC;
import static com.ansh.rmbarcodetest.parser.specs.Occurrence.R;
import static com.ansh.rmbarcodetest.parser.specs.Occurrence.U;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.compartmentCode;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.dateOfFlight;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.dateOfPassIssuance;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.documentType;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.documentVerification;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.electronicTicketIndicator;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.fastTrack;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.formatCode;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.freeBaggageAllowance;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.hexValue;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.idAdIndicator;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.passengerDescription;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.passengerStatus;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.selecteeIndicator;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.sourceOfCheckin;
import static com.ansh.rmbarcodetest.parser.specs.ValueDescriptions.sourceOfPassIssuance;
